...
- The finish-line paper status needed an explicit repo-local note once the unpublished draft was intentionally kept out of the public repo.
...
- What it does:
  ...
  - validates the repo-local package files, the MSI soak-machine note, and the paper-draft status note
